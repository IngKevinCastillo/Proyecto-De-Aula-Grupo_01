...
public class Gerente extends Usuario{
    ...
    public void generarInforme(Sala sala, Recepcionista recepcionista){
        datos.listMesas(sala);
        datos.listReserva(recepcionista);
    }

    public void inicializarDatos(Datos datos) {
        this.datos = datos;
    }*/
}
